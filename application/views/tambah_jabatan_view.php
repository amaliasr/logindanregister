				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
						<?php echo form_open_multipart('jabatan/create/'.$this->uri->segment(3)); ?>
								...
								<button type="submit" class="btn btn-primary">Submit</button> <a href="<?php echo site_url('jabatan/index/').$this->uri->segment(3) ?>" type="button" class="btn btn-info">Batal</a>
					<?php echo form_close(); ?>
					</div>
					</div>
